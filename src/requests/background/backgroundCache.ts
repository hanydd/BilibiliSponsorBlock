...
export const segmentsCache = new PersistentTTLCache<BVID, SegmentResponse>(SEGMENTS_CACHE_KEY, HOUR_MS, 4096);

/**
 * Video Label Cache
 */
const VIDEO_LABEL_CACHE_KEY = "bsb_cache_video_labels";
export const videoLabelCache = new PersistentTTLCache<string, LabelBlock>(VIDEO_LABEL_CACHE_KEY, HOUR_MS, 4096);
